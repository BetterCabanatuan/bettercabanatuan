  ...
  return (
    <>
      <SEO
        ...
        description={`Explore all ${allBarangays.length} barangays of ${import.meta.env.VITE_GOVERNMENT_NAME}. Find information about urban and rural barangays, their classifications, and local details.`}
      ...
      <Section className="p-3 mb-12">
        ...
        <Text className="text-gray-600 mb-6">
          {filter === 'urban'
            ? `Explore the ${urbanCount} urban barangays of ${import.meta.env.VITE_GOVERNMENT_NAME}.`
            : filter === 'rural'
              ? `Explore the ${ruralCount} rural barangays of ${import.meta.env.VITE_GOVERNMENT_NAME}.`
              : `Explore all ${allBarangays.length} barangays of ${import.meta.env.VITE_GOVERNMENT_NAME}. The city is divided into urban and rural barangays, each with its own character and community.`}
        </Text>
